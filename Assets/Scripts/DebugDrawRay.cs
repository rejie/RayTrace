...
public class DebugDrawRay : MonoBehaviour {
	...
	void Update () {
        ...
        //Debug.Log(Camera.main.ScreenPointToRay(screenPos).ToString("F6") + " " + Camera.main.ScreenPointToRay(screenPos + new Vector3(0.5f, 0.5f, 0.0f)).ToString("F6"));
        ...
        Debug.Log(new Color(1, 1, 1) * new Color(0.2f, 0.2f, 0.2f));
    }
}
